...
// src/modules/jobs/service/calendar.ts because that file pulls in Prisma +
// googleapis, which can't reach the browser bundle where this guess is
// actually used (prefilling the "Add to Calendar" dialog).
