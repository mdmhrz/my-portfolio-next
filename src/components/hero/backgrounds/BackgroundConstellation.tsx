...
import { EnvironmentConstellation } from './EnvironmentConstellation';
...
export function BackgroundConstellation({ reduced }: { reduced: boolean }) {
    ...
    <div ref={containerRef} aria-hidden className="absolute inset-0" style={{ pointerEvents: 'none' } as CSSProperties}>
      ...
      >
        ...
        <Suspense fallback={null}>
          <EnvironmentConstellation color={color} />
        </Suspense>
      </Canvas>
    </div>
  );
