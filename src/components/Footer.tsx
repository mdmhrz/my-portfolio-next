...
export function Footer() {
  ...
  return (
    <footer className="relative pt-24 pb-12 overflow-hidden bg-background">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-px bg-gradient-to-r from-transparent via-primary/50 to-transparent" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="space-y-4">
              <div className="text-primary font-display font-bold text-3xl tracking-tighter">
                MHR.DEV
              </div>
              ...
              {["Hero", "Journey", "Experience", "Workflow", "Projects"].map((item) => (
                <li key={item}>
                  <a
                    ...
                    className="text-muted-foreground hover:text-primary font-mono text-sm tracking-tight transition-colors flex items-center gap-2 group"
                  >
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-6 border-primary/20 bg-primary/5 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-mono font-bold text-primary uppercase tracking-widest">Available for Hire</span>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Currently open to new opportunities and interesting technical challenges.
              </p>
              <Button variant="outline" size="sm" className="w-full border-primary/20 text-primary hover:bg-primary/10 text-xs font-bold uppercase tracking-widest h-9">
